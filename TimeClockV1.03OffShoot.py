...
def getFirstName(id):
    ...
    for i in range(len(employeeArray)):
        if(employeeArray[i].idNumber == id):
            return employeeArray[i].firstname
    print("matchID did not find a match")
    return None
...
def getLastName(id):
    ...
    for i in range(len(employeeArray)):
        if(employeeArray[i].idNumber == id):
            return employeeArray[i].lastname
    print("matchID did not find a match")
    return None
...
def getvisualSettings(id):
    ...
    for i in range(len(employeeArray)):
        if(employeeArray[i].idNumber == id):
            return employeeArray[i].visualSettings
    print("matchID did not find a match")
    return None
...
def getAudioSettings(id):
    ...
    for i in range(len(employeeArray)):
        if(employeeArray[i].idNumber == id):
            return employeeArray[i].audioSettings
    print("matchID did not find a match")
    return None
...
def exportData():
    ...
    exportDoneButton = Button(exportSettingsWindow, fg= textColor, text= "Done", padx="5", pady="5", bg= buttonColor, command=exportDoneButton, relief=FLAT).pack()
